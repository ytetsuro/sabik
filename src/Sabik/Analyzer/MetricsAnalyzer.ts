...
export class MetricsAnalyzer {
    private complexityAnalyzer: ASTAnalyzer<ComplexityCountableNode, ComplexityStore>;
    ...
    constructor(
      ...
      this.complexityAnalyzer = new ASTAnalyzer(new ComplexityCalculator(), complexityConverter)
      this.halsteadAnalayzer = new ASTAnalyzer(new HalsteadCalculator(), halstedConverter)
      this.lineOfCodeAnalayzer = new ASTAnalyzer(new LineOfCodeCalculator(), lineOfCodeConverter)
    }
