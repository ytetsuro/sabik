...
export class Analyzer {
    ...
    private lineOfCodeAnalyzer: SourceCodeAnalyzer<LineOfCodeCountableNode, LineOfCode>;
    ...
    constructor({
      ...
      this.lineOfCodeAnalyzer = new SourceCodeAnalyzer(new Calculator(), lineOfCodeConverter)
    }

    analyze(filePath: File) {
      const astNode = this.astGenerator.generate(filePath.fullPath);
      this.analyzedFactory.setFileMeta(filePath.relativePath, this.lineOfCodeAnalyzer.analyze(astNode));
